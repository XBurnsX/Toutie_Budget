...
class FirebaseService {
  ...
  Future<void> ajouterTransaction(app_model.Transaction transaction) async {
    ...
    // La logique de remboursement de carte de crédit a été déplacée dans AjoutTransactionController
    // pour éviter le double traitement. Le service ne fait plus que sauvegarder la transaction.
  }
